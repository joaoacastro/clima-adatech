...
form === null || form === void 0 ? void 0 : form.addEventListener("submit", (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const resposta = yield fetch(`https://api.openweathermap.org/data/2.5/forecast?q=${localizacao}&appid=35050c22c2c3ac8d260aa5742de645a6&lang=pt_br&units=metric`);
        if (!resposta.ok) {
        ...
        const previsoes = dados.list.filter((item, index) => index % 7 === 0);
        const infos = {
        ...
        alert(`A cidade ${input.value} não existe ou não foi encontrada. Por favor, digite um nome válido para cidade.`);
        input.value = "";
        return;
    }
}));
